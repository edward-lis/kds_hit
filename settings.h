...
public:
    ...
    quint16 offsetADC2;
    quint16 offsetADC2_plus; ///< Код смещения(компенсация) АЦП при измерении напряжения на корпусе +
    quint16 offsetADC2_minus; ///< Код смещения(компенсация) АЦП при измерении напряжения на корпусе -
