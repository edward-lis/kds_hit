...
Name: "{group}\КДС ХИТ"; Filename: "{app}\kds_hit.exe"; IconFilename: "{app}\kds_hit.exe"; IconIndex: 0
Name: "{userdesktop}\КДС ХИТ"; Filename: "{app}\kds_hit.exe"; IconFilename: "{app}\kds_hit.exe"; IconIndex: 0; Tasks: desktopicon
Name: "{userappdata}\Microsoft\Internet Explorer\Quick Launch\КДС ХИТ"; Filename: "{app}\kds_hit.exe"; IconFilename: "{app}\kds_hit.exe"; IconIndex: 0; Tasks: quicklaunchicon
